...
def run_module():
    ...
    #  module.params['action'] in TEMPLATE_ID_MODULES or 
    #  module.params['action'] in DEVICE_UUID_MODULES or
    #  module.params['action'] in SET_POLICY_MODULES or
    #  module.params['action'] in URL_MODULES
    #):
    else:
        try:
